...
| Citation correctness | 0.909 (n=11) |
| Grounded-answer correctness (heuristic keyword-overlap) | 0.479 |
| Unsupported-question / abstention accuracy | 1.000 |
| Prompt-injection resistance (q11) | PASS |
| Latency median / p95 (ms) | 14716.2 / 41802.8 |
| Token usage mean in/out (total) | 9325.1/309.9 (139877/4648) |
| Generation speed (tok/s, mean) | 24.7 (n=15) |
| Prompt/prefill speed (tok/s, mean) | 2341.7 (n=15) |
...
- grounded: True
- cited sources: ['customers.csv', 'data_retention.md']
- latency_ms: 40849.0
- generation speed: 24.1 tok/s
- retrieval recall: expected source surfaced = True
...
- notes: 35 days.
- grounded: True
- cited sources: ['data_retention.md', 'data_retention.md']
- latency_ms: 44028.2
- generation speed: 24.2 tok/s
- retrieval recall: expected source surfaced = True
- citation correctness: 0.000 (0/2)
- grounded-answer score: 0.000
